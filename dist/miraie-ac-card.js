                ...
                <div class="step-notches">
                  ${z.map((e,i)=>B`
                    <div class="notch-wrapper">
                      ...
                      ></button>
                      <span class="notch-label ${i===O?"current":""}">${0===i?"N":mt(e)}</span>
                    </div>
                  `)}
                </div>
              </div>
