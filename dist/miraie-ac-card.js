 ...
 */
const e=globalThis,i=e.ShadowRoot&&(void 0===e.ShadyCSS||e.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,s=Symbol(),o=new WeakMap;let r=class{constructor(t,e,i){if(this._$cssResult$=!0,i!==s)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=t,this.t=e}get styleSheet(){let t=this.o;const e=this.t;if(i&&void 0===t){const i=void 0!==e&&1===e.length;i&&(t=o.get(e)),void 0===t&&((this.o=t=new CSSStyleSheet).replaceSync(this.cssText),i&&o.set(e,t))}return t}toString(){return this.cssText}};const n=i?t=>t:t=>t instanceof CSSStyleSheet?(t=>{let e="";for(const i of t.cssRules)e+=i.cssText;return(t=>new r("string"==typeof t?t:t+"",void 0,s))(e)})(t):t,{is:a,defineProperty:c,getOwnPropertyDescriptor:l,getOwnPropertyNames:d,getOwnPropertySymbols:p,getPrototypeOf:h}=Object,m=globalThis,u=m.trustedTypes,g=u?u.emptyScript:"",v=m.reactiveElementPolyfillSupport,_=(t,e)=>t,f={toAttribute(t,e){switch(e){case Boolean:t=t?g:null;break;case Object:case Array:t=null==t?t:JSON.stringify(t)}return t},fromAttribute(t,e){let i=t;switch(e){case Boolean:i=null!==t;break;case Number:i=null===t?null:Number(t);break;case Object:case Array:try{i=JSON.parse(t)}catch(t){i=null}}return i}},b=(t,e)=>!a(t,e),y={attribute:!0,type:String,converter:f,reflect:!1,useDefault:!1,hasChanged:b};
/**
 * @license
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const ct={attribute:!0,type:String,converter:f,reflect:!1,hasChanged:b},lt=(t=ct,e,i)=>{const{kind:s,metadata:o}=i;let r=globalThis.litPropertyMetadata.get(o);if(void 0===r&&globalThis.litPropertyMetadata.set(o,r=new Map),"setter"===s&&((t=Object.create(t)).wrapped=!0),r.set(i.name,t),"accessor"===s){const{name:s}=i;return{set(i){const o=e.get.call(this);e.set.call(this,i),this.requestUpdate(s,o,t,!0,i)},init(e){return void 0!==e&&this.C(s,void 0,t,e),e}}}if("setter"===s){const{name:s}=i;return function(i){const o=this[s];e.call(this,i),this.requestUpdate(s,o,t,!0,i)}}throw Error("Unsupported decorator location: "+s)};
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
    ...
    `:this._renderCompact(e,r,o,n,g,l,a,c,U)}_togglePanel(t){this._haptic("selection"),this._openPanel=this._openPanel===t?null:t}_haptic(t="light"){this.dispatchEvent(new CustomEvent("haptic",{detail:t,bubbles:!0,composed:!0}))}_showMoreInfo(t){this._haptic("selection"),this.dispatchEvent(new CustomEvent("hass-more-info",{bubbles:!0,composed:!0,detail:{entityId:t}}))}_togglePower(t){this._haptic("medium"),"off"!==t.state?this.hass.callService("climate","set_hvac_mode",{entity_id:t.entity_id,hvac_mode:"off"}):this.hass.callService("climate","turn_on",{entity_id:t.entity_id})}_adjustTemp(t,e,i){if(this._haptic("light"),null==e)return;const s=Number(e)+t;null!=i&&(t<0&&s<Number(i)||t>0&&s>Number(i))||this.hass.callService("climate","set_temperature",{entity_id:this._config.entity,temperature:s})}_setHvacMode(t){this._haptic("light"),this.hass.callService("climate","set_hvac_mode",{entity_id:this._config.entity,hvac_mode:t})}_setFanMode(t,e){this._haptic("selection"),this.hass.callService("climate","set_fan_mode",{entity_id:t.entity_id,fan_mode:e})}_setSwing(t,e){this._haptic("selection"),this.hass.callService("climate","set_swing_mode",{entity_id:t.entity_id,swing_mode:e})}_setHSwing(t,e){this._haptic("selection"),this.hass.callService("climate","set_swing_horizontal_mode",{entity_id:t.entity_id,swing_horizontal_mode:e})}_setPreset(t){this._haptic("light"),this.hass.callService("climate","set_preset_mode",{entity_id:this._config.entity,preset_mode:t})}_toggleSwitch(t,e){this._haptic("light"),this.hass.callService("switch","on"===e?"turn_off":"turn_on",{entity_id:t})}_pressButton(t){this._haptic("medium"),this.hass.callService("button","press",{entity_id:t})}_modeLabel(t){return{cool:"Cool",dry:"Dry",fan_only:"Fan",auto:"Auto",heat:"Heat",off:"Off"}[t]??t.charAt(0).toUpperCase()+t.slice(1)}_modeIcon(t){return{cool:"mdi:snowflake",dry:"mdi:water-percent",fan_only:"mdi:fan",auto:"mdi:cached",heat:"mdi:fire"}[t]??"mdi:air-conditioner"}_presetIcon(t){return{eco:"mdi:leaf",boost:"mdi:rocket",none:"mdi:close-circle-outline"}[t]??"mdi:play-circle-outline"}_renderGoogleHomeFull(t,e,i,s,o,r,n,a,c){const l=this._config,d=t.attributes,p=d.hvac_modes||[];"unavailable"!==t.state&&t.state;const h=i?"fan_only"===r?"FA":null!=s?`${s}°`:"--":"Off",m=null!=o?`Indoor ${o}°`:"";let u=["none"],g=[];if(d.preset_modes&&(u=["none",...d.preset_modes.filter(t=>!/^cv[\s_]/.test(t))],g=d.preset_modes.filter(t=>/^cv[\s_]/.test(t)),g.length>0)){const t=g[0].substring(0,3);g.includes(`${t}0`)||g.push(`${t}0`)}const v=g.sort((t,e)=>mt(e)-mt(t)),_=l.nanoe_switch?this.hass.states[l.nanoe_switch]:void 0,f=l.display_switch?this.hass.states[l.display_switch]:void 0,b=l.coil_clean_button?this.hass.states[l.coil_clean_button]:void 0,y=l.coil_cleaning_sensor?this.hass.states[l.coil_cleaning_sensor]:void 0,$=l.energy_today_sensor?this.hass.states[l.energy_today_sensor]:void 0,x=l.energy_yesterday_sensor?this.hass.states[l.energy_yesterday_sensor]:void 0,w=l.rssi_sensor?this.hass.states[l.rssi_sensor]:void 0;return F`
      <ha-card style="${c}" class="gh-full-card">
        ...
        <div class="gh-action-row">
          <button class="gh-circular-btn" ?disabled=${!i||"fan_only"===r} @click=${t=>{t.stopPropagation(),this._adjustTemp(-.5,s,n)}}>
            <ha-icon icon="mdi:minus"></ha-icon>
          </button>
          <div style="width: 48px;"></div>
          <button class="gh-circular-btn" ?disabled=${!i||"fan_only"===r} @click=${t=>{t.stopPropagation(),this._adjustTemp(.5,s,a)}}>
            <ha-icon icon="mdi:plus"></ha-icon>
          </button>
        </div>
        ...
        <div class="gh-select-container">
          ...
          <!-- Preset Dropdown -->
          <div class="gh-select-wrapper" style="${i&&"fan_only"!==r?"":"opacity: 0.5; pointer-events: none;"}">
          ...
          ${v.length>0?F`
            <div class="gh-select-wrapper" style="${!i||["dry","auto","fan_only"].includes(r)?"opacity: 0.5; pointer-events: none;":""}">
              <button class="gh-custom-select" @click=${t=>{t.stopPropagation(),this._ghDropdown="cv"===this._ghDropdown?null:"cv"}}>
                <span>${t.attributes.preset_mode&&/^cv[\s_]/.test(t.attributes.preset_mode)?0===mt(t.attributes.preset_mode)?"Normal":mt(t.attributes.preset_mode)+"%":"Normal"}</span>
                <ha-icon icon="mdi:chevron-down"></ha-icon>
              </button>
    ...
    `}_renderCompact(t,e,i,s,o,r,n,a,c){"unavailable"!==t.state&&t.state;return F`
      <ha-card style="${c}" class="compact-card" @click=${()=>{this._haptic("selection"),this._expanded=!0}}>
        ...
        <div class="compact-center">
          <div class="compact-value">${i?"fan_only"===r?"FA":null!=s?`${s}°`:"--":"Off"}</div>
        </div>
