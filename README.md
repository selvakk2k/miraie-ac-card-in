...
While designed specifically to work with the [`selvakk2k/ha-miraie-ac-in`](https://github.com/selvakk2k/ha-miraie-ac-in) custom integration, it remains backward-compatible with the upstream [`rkzofficial/ha-miraie-ac`](https://github.com/rkzofficial/ha-miraie-ac) integration. Note: under the upstream integration, capacity controls will be limited to Converti7 (Converti8 is not supported), and features like Today's Consumption, Coil Cleaning and Filter Clean alerts will not be available as they are not exposed as entities by it.
